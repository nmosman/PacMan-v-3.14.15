...
**********************************************************************************************************************************************
** loseGame()
** - displays loss message and resets game after user presses any button
** 
*/
.globl loseGame
loseGame:
...
**********************************************************************************************************************************************
** winGame()
** - displays win message and resets game after user presses any button- 
** 
*/
.globl winGame	
winGame:
...
**********************************************************************************************************************************************
** drawGameEndScreen()
** - draws dark rectangle across the game board for displaying the result after the game has ended
** Param:
